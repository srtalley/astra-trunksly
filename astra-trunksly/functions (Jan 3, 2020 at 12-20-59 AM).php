...
function trunksly_change_product_html( $price_html, $product ) {
	...
	$is_member = get_current_user_role();
	...
	if($is_member) {
		if($product->is_on_sale()) {
			...
			$new_price_html .= '<span class="trunksly-sale-price woocommerce-Price-amount">Sale Price: <span class="trunksly-strikethrough">' . wc_price($product->get_regular_price()) . '</span></span>';
		}
		...
		if($product->is_on_sale()) {
			...
			$new_price_html .= '<span class="trunksly-regular-price woocommerce-Price-amount">Sale Price: <ins>' . wc_price($product->get_regular_price()) . '</ins></span>';
			$price_to_use_for_trunksly_plus_calc = $product->get_sale_price();
		}
...
function get_current_user_role() {
 ...
 } // end function get_current_user_role
